...
export const MEGA_SHELL_CARD_CN =
  'flex min-h-0 flex-1 flex-col overflow-hidden rounded-none border-0 bg-transparent py-0 shadow-none sm:rounded-2xl sm:border sm:border-soft sm:bg-card sm:shadow-sm lg:h-full lg:max-h-full lg:min-h-0';

export const MEGA_SHELL_CONTENT_CN = 'flex h-full min-h-0 flex-1 flex-col gap-0 p-0';

export const MEGA_PANEL_HEADER_CN =
  'flex h-10 min-h-10 shrink-0 items-center justify-between gap-2 border-b border-soft bg-panel px-3 sm:h-11 sm:min-h-11 sm:px-4';

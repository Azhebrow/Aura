...
export function EvilDottedAreaChart({ data, series, chartConfig, patternId, meta, mode }: Props) {
  void patternId;
  return (
    <ChartContainer
      config={chartConfig}
    ...
    >
      <LineChart accessibilityLayer data={data} margin={{ top: 8, right: 12, left: 4, bottom: 8 }}>

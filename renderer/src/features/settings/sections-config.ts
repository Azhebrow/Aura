...
export const SETTINGS_SECTIONS: SettingsSectionDef[] = [
  ...
  { id: 'rituals-morning', title: 'Утро', configKey: 'rituals-morning' },
  { id: 'rituals-evening', title: 'Вечер', configKey: 'rituals-evening' },
  ...
  { id: 'diary-entry-presets', title: 'Цитаты', configKey: 'diary-entry-presets' },
  { id: 'ambient-music', title: 'Музыка', configKey: 'ambient-music' },
